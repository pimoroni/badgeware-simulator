...
extern const struct _mp_obj_module_t modpicovector;
#undef MODULE_DEF_PICOVECTOR
#define MODULE_DEF_PICOVECTOR { MP_ROM_QSTR(MP_QSTR_picovector), MP_ROM_PTR(&modpicovector) },
