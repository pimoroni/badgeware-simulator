...
class Obstacle:
  ...
  def draw(self):
    ...
    screen.scale_blit(sprites.sprite(1, 0), self.x, self.gap_y - 24, 24, 24) # spikes, yikes!

    # draw the bottom half off the obstacle
    screen.scale_blit(sprites.sprite(1, 0), self.x, self.gap_y + self.gap_height, 24, -24) # spikes, yikes!
