  ...
  def update(self):
    ...
    for obstacle in Obstacle.obstacles:
      ...
      for obstacle_bounds in obstacle.bounds():
        ...
        x2 = min(obstacle_bounds[0] + obstacle_bounds[2], mona_bounds[0] + mona_bounds[2])
        y2 = min(obstacle_bounds[1] + obstacle_bounds[3], mona_bounds[1] + mona_bounds[3])
      ...
      if obstacle.passed == False and obstacle.x < self.pos[0]:
