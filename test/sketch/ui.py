...
def draw_background():
  ...
  screen.draw(shapes.rounded_rectangle(canvas_area[0] + 3, canvas_area[1], canvas_area[2] - 5, 3, 2))
  screen.draw(shapes.rounded_rectangle(canvas_area[0], canvas_area[1] + 3, 3, canvas_area[3] - 5, 2))
...
def draw_dial(angle, pos):
  ...
  for i in range(0, ticks):
    ...
    inner = (pos[0] + math.sin(r) * (radius - 3), pos[1] + math.cos(r) * (radius - 3))
