...
# def font_command(image, parameters, cursor, measure):
#   if measure:
#     return 0
...
#       window.pen = image.pen # TODO: nasty hack while global brush isn't set properly
