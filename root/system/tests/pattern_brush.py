...
def update():
  ...
  custom_pattern = brush.pattern(screen, color.rgb(255, 100, 100, 100), color.rgb(0, 0, 0, 0), (
    0b00000000,
    0b01111110,
    0b01000010,
    0b01011010,
  ...
  built_in_pattern = brush.pattern(screen, color.rgb(100, 255, 100, 100), color.rgb(0, 0, 0, 0), 11)
  pen(built_in_pattern)
  screen.shape(shape.circle(160 + math.sin(io.ticks / 250) * 60, 120 + math.cos(io.ticks / 500) * 60, 60))

  built_in_pattern = brush.pattern(screen, color.rgb(100, 100, 255, 100), color.rgb(0, 0, 0, 0), 8)
  pen(built_in_pattern)
